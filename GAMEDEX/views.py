...
def inicio(request):
    ...
    print("TOTAL PRODUCTOS BD:", Producto.objects.count())
    print("PUBLICADOS:", Producto.objects.filter(publicado=True).count())
    print("DESTACADOS:", Producto.objects.filter(destacado=True).count())
...
def dashboard_admin(request):
    ...
    #  CONTADORES
    total_cliente = User.objects.filter(groups__name="Cliente").count()
